...
Copy
# Integrate the new upgrade section into the existing CIRC Services documentation

markdown_circ_with_upgrade = """
# CIRC Services for MINTS
...
| **mdash.circ (Data Processing)** | 16 | 64 GB | 2 TB   | Expand for InfluxDB, Grafana, Node-RED pipelines, containerized analytics. |
